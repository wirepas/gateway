...
class KeepAliveMessage():
    ...
    Attributes:
        ...
        rtc_timestamp_s: Unix epoch timestamp (seconds since January 1, 1970).
    ...
    """
    def __init__(self, version, gateway_status=None, rtc_timestamp_s=None,
                 timezone_offset_mn=None, keep_alive_interval_s=None):
        self.version = version
        self.gateway_status = gateway_status
        self.rtc_timestamp_s = rtc_timestamp_s
    ...
    def encode_tlv(self):
        ...
        logging.debug(f"Prepare keep alive message with version={self.version}, "
                      ...
                      f"rtc_timestamp_s={self.rtc_timestamp_s}, "
        ...
        if self.rtc_timestamp_s is not None and \
                self.timezone_offset_mn is not None:
            buffer += KeepAliveMessage._encode_tlv_item(
                KeepAliveType.RTC_TIMESTAMP_TYPE, 4, self.rtc_timestamp_s, "I",
            )
            buffer += KeepAliveMessage._encode_tlv_item(
