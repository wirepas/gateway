...
class TopicGenerator:
    ...
    def make_set_config_request_topic(gw_id='+', sink_id='+'):
        return TopicGenerator._make_request_topic("set_config", [str(gw_id), str(sink_id)])

    @staticmethod
    def make_send_data_request_topic(gw_id='+', sink_id='+'):
        return TopicGenerator._make_request_topic("send_data", [str(gw_id), str(sink_id)])

    @staticmethod
    def make_otap_status_request_topic(gw_id='+', sink_id='+'):
        return TopicGenerator._make_request_topic("otap_status", [str(gw_id), str(sink_id)])

    @staticmethod
    def make_otap_load_scratchpad_request_topic(gw_id='+', sink_id='+'):
        return TopicGenerator._make_request_topic("otap_load_scratchpad", [str(gw_id), str(sink_id)])

    @staticmethod
    def make_otap_process_scratchpad_request_topic(gw_id='+', sink_id='+'):
        return TopicGenerator._make_request_topic("otap_process_scratchpad", [str(gw_id), str(sink_id)])
    ...
    def make_set_config_response_topic(gw_id, sink_id):
        return TopicGenerator._make_response_topic("set_config", [str(gw_id), str(sink_id)])

    @staticmethod
    def make_send_data_response_topic(gw_id, sink_id):
        return TopicGenerator._make_response_topic("send_data", [str(gw_id), str(sink_id)])

    @staticmethod
    def make_otap_status_response_topic(gw_id='+', sink_id='+'):
        return TopicGenerator._make_response_topic("otap_status", [str(gw_id), str(sink_id)])

    @staticmethod
    def make_otap_upload_scratchpad_response_topic(gw_id='+', sink_id='+'):
        return TopicGenerator._make_response_topic("otap_load_scratchpad", [str(gw_id), str(sink_id)])

    @staticmethod
    def make_otap_process_scratchpad_response_topic(gw_id='+', sink_id='+'):
        return TopicGenerator._make_response_topic("otap_process_scratchpad", [str(gw_id), str(sink_id)])
    ...
    @staticmethod
    def make_received_data_topic(gw_id='+', sink_id='+', network_id='+', src_ep='+', dst_ep='+'):
        return TopicGenerator._make_event_topic("received_data",
                                                [str(gw_id),
                                                 str(sink_id),
                                                 str(network_id),
                                                 str(src_ep),
