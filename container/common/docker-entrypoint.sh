...
export WM_SERVICES_MQTT_PORT
export WM_SERVICES_MQTT_USERNAME
export WM_SERVICES_MQTT_PASSWORD
...
WM_SERVICES_MQTT_PORT="${WM_SERVICES_MQTT_PORT:-${WM_SERVICES_MQTT_PORT}}"
WM_SERVICES_MQTT_USERNAME="${WM_SERVICES_MQTT_USERNAME:-${WM_SERVICES_MQTT_USER}}"
WM_SERVICES_MQTT_PASSWORD="${WM_SERVICES_MQTT_PASSWORD:-${WM_SERVICES_MQTT_PASSWORD}}"
