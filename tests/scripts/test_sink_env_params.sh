...
function test_env_acquisition
{
    ...
    _RULE="WM_GW_SINK_BITRATE: ${WM_GW_SINK_BITRATE}"
    content_in_file "${_RULE}" "${LOGFILE}"
...
{
    WM_GW_SINK_BITRATE=
...
generate_sink_service_env_args()
{
    ...
    WM_GW_SINK_BITRATE=$(shuf -i 12500-100000 -n 1)
